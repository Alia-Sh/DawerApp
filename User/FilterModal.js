...
export default class FilterModal extends Component {
    constructor(props) {
        ...
        this.state = {
            Area:
                [
                    {ID:0, Name:"من الأقرب إلى الأبعد",selected:false},
                    {ID:1, Name:"من الأبعد إلى الأقرب",selected:false},
                ]
            ,alertVisible:true
            ,AreaSelected:''
        };
    ...
    return(
            <View style={styles.modalView}>
                        ...
                        <TouchableOpacity onPress={()=>{this.changeSelect(item.ID)}}>
                            <View style={{flexDirection:'row-reverse'}}>
                                <Text style={[styles.textStyle,{
                                            color:item.selected?'#9E9D24':"#161924",
                                            fontSize:item.selected?16:16,
                ...
                <TouchableOpacity 
                    ...
                    onPress={()=>{
                        this.props.filterFacilities(this.state.AreaSelected)
                }}>
